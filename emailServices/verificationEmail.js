module.exports = ({ username,url }) => {
    ...
    <html lang="en">
        ...
        ">Email verification</span>
                    ...
                    <a href="${url}" style="text-decoration: none; text-align: center; display: block; width: 200px; margin: 10px auto; padding: 10px 20px; background: #EB4747; color: white; font-weight: bold; border-radius: 5px;">Verify my email address</a>
                ...
                <img
                        height="50px"
                        style="margin: 0px auto; margin-top: 20px; width: auto; display: block;"
